...
const KidsAllStylesContainer = ({setAppState, kidsShoes, onShoeClick, totalItems}) => {

    const productListNodes = kidsShoes.map((shoe, index) => {
...
export default KidsAllStylesContainer;